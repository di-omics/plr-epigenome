...
#
# Geometry changes requested after HEIGHT_ONLY observation:
# - aspirate height lowered by ~3 mm
# - aspirate Y increased
# - dispense Y increased
# - dispense X decreased
# - dispense Z/effective height decreased
# -----------------------------------------------------------------------------
...
#
# This refine pass:
P10_96DW_ASP_HEIGHT = [12.0] * 8
P10_96DW_ASP_OFFSETS = [Coordinate(0.20, 3.05, 0.0)] * 8

P10_WORK_DSP_HEIGHT = [17.0] * 8
P10_WORK_DSP_OFFSETS = [Coordinate(-0.15, 3.15, 0.0)] * 8
