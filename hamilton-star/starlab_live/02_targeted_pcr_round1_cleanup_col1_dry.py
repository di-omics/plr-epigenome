...
# Targeted PCR library preparation - PCR1 cleanup dry motion scaffold, column 1 only
#
# Purpose:
...
async def main():
    parser = argparse.ArgumentParser(description="Targeted PCR round 1 cleanup dry-offset/motion test: mag pos2 + trough pos3.")
    parser.add_argument(
        "--mode",
