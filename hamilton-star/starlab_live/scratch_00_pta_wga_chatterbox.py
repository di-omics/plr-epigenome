...
async def main():
    parser = argparse.ArgumentParser(description="Bio Validation 0 PTA/WGA beginning staged additions: lysis and reaction mix, swap-source discard-tip version.")
    ...
    lh = LiquidHandler(backend=STARChatterboxBackend(), deck=STARDeck())
