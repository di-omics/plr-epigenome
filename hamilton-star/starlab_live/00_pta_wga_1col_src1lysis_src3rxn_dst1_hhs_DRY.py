...
# - Lysis Mix 3.0 uL: source rail35 pos1 COL 1 -> dest rail35 pos0 COL 1 (p10 tip col 1).
# - Reaction Mix 6.0 uL: source rail35 pos1 COL 3 -> dest rail35 pos0 COL 1 (p10 tip col 2).
...
async def main():
    parser = argparse.ArgumentParser(description="PTA/WGA single-column dry rehearsal: lysis source col 1 and reaction source col 3 into dest col 1, then iSWAP work plate to HHS rail27 pos2.")
    ...
    try:
        ...
        if args.mode == "single-col-hhs":
            if args.confirm != "RUN_SINGLE_COL_PTA_HHS":
                raise RuntimeError("Refusing to run. Add: --confirm RUN_SINGLE_COL_PTA_HHS")
            if discard_tips:
