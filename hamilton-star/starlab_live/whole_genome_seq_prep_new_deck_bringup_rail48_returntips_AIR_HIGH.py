...
# - AIR-HIGH DEV/DRY variant: all tips are returned to racks instead of discarded.
# - All aspirate/dispense geometry is intentionally raised high above labware.
# - Use this only to observe XY pathing and gross clearance, not real liquid handling.
#
...
SAFE_96WP_DSP_HEIGHT = [40.0] * 8
SAFE_96WP_DSP_OFFSETS = [Coordinate(DSP_X_RIGHT_SHIFT, 2.45, 60.0)] * 8

# Conservative source 96DW aspirate locations.
P10_96DW_ASP_HEIGHT = [40.0] * 8
P10_96DW_ASP_OFFSETS = [Coordinate(0.20, 2.30, 60.0)] * 8
P50_96DW_ASP_HEIGHT = [40.0] * 8
P50_96DW_ASP_OFFSETS = [Coordinate(0.20, 2.30, 60.0)] * 8

# Trough geometry copied from prior p300 add/remove style, but used only for simple add tests here.
P300_TROUGH_ASP_HEIGHT = [40.0] * 8
P300_TROUGH_ASP_OFFSETS = [Coordinate(0.0, 1.5, 60.0)] * 8
P1000_TROUGH_ASP_HEIGHT = [40.0] * 8
P1000_TROUGH_ASP_OFFSETS = [Coordinate(0.0, 1.5, 60.0)] * 8

# Elevated plate dispense geometry for p300/p1000 into 96WP or magnetic 96WP position.
P300_96WP_DSP_HEIGHT = [40.0] * 8
P300_96WP_DSP_OFFSETS = [Coordinate(-0.60, 1.55, 60.0)] * 8
P1000_96WP_DSP_HEIGHT = [40.0] * 8
P1000_96WP_DSP_OFFSETS = [Coordinate(-0.60, 1.55, 60.0)] * 8
