...
#   p10 height = 13.0, offset = Coordinate(0.35, 4.85, 0.0)
#   p50 height = 11.5, offset = Coordinate(0.35, 4.85, 0.0)
#   Note: Y is intentionally increased to 4.85 after source aspirate edge observation.
...
P10_SOURCE_96DW_ASP_OFFSETS = [Coordinate(0.35, 4.85, 0.0)] * 8
