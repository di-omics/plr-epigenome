...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    print("Assigning WGS preparation V2 truth-set scaffold deck...")
...
async def main():
    parser = argparse.ArgumentParser(description="WGS preparation V2 truth-set scaffold: source pos1 96WP, mag pos2.")
