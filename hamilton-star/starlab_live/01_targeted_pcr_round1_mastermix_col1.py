...
# Targeted PCR library preparation - PCR1 master-mix addition, column 1 only
#
# Purpose:
...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    print("Assigning Targeted PCR round 1 deck: WGS/Bio Validation 0 compatible column-1 layout...")
...
async def main():
    parser = argparse.ArgumentParser(
        description="Targeted PCR round 1 master-mix addition, column 1, WGS/Bio Validation 0 compatible deck."
    )
