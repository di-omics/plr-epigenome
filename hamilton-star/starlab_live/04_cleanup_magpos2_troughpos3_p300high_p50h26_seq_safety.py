...
# - This version raises p300 mag dispense to height 16.0 / z 25.0 for a high-safe dry retest.
# - p300 mag remove is restored to height 32.0 for a safer isolated remove retest.
# - p50 residual stays at height 26.0.
# - Re-tune down only after each isolated motion is visually confirmed safe.
#
...
P300_MAG_DSP_OFFSETS = [Coordinate(-0.72, 2.20, 25.0)] * 8
...
ACTIONS = {
    "beads-add-dry": CleanupAction(
        mode="beads-add-dry",
        label="Add SPRI cleanup beads / bead mimic",
        kind="add",
