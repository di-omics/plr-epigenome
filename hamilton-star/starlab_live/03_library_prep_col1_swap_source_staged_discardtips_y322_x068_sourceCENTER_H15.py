...
# - Work/destination dispense remains validated side-wall geometry Coordinate(-0.68, 3.22, 0.0), height 3.3.
...
P10_SOURCE_ASP_OFFSETS = [Coordinate(0.0, 0.0, 0.0)] * 8
...
P50_SOURCE_ASP_OFFSETS = [Coordinate(0.0, 0.0, 0.0)] * 8
...
async def main():
    parser = argparse.ArgumentParser(description="validation production staged column-1 library prep additions, swap-source discard-tip version.")
