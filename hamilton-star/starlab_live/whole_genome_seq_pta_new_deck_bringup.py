...
# -----------------------------------------------------------------------------
# WGS preparation (PTA) - NEW DECK BRINGUP / BASIC MOVEMENTS
...
async def run_whole_genome_seq_addition_scaffold(lh: LiquidHandler, r: Dict[str, object]):
    ...
    print("\n=== WGS preparation ADDITION SCAFFOLD: 20 uL library amp with p50 ===")
...
async def main():
    parser = argparse.ArgumentParser(description="STAR new-deck bringup for WGS preparation (PTA) automation")
    parser.add_argument(
        "--mode",
