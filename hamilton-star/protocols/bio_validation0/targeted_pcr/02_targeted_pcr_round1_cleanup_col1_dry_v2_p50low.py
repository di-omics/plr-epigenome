...
# - PCR1 cleanup target: 25 uL PCR1 + 22.5 uL SPRI cleanup beads = 0.9X.
...
#
# Reservoir map:
#   A1  = SPRI cleanup beads / bead mimic
...
ACTIONS = {
    "beads-add-dry": CleanupAction("beads-add-dry", "Add 0.9X SPRI cleanup beads / bead mimic", "add", TROUGH_BEADS, VOL_BEADS),
...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    ...
    print("\nReservoir map:")
    print(f"  {TROUGH_BEADS} = SPRI cleanup beads / bead mimic")
