...
# Targeted PCR library preparation - PCR2 common master-mix addition, column 1 only
#
# Purpose:
...
PCR2_MM_STEP = Step(
    mode="pcr2-mm",
    label="Targeted PCR round 2 common master mix",
...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    print("Assigning Targeted PCR round 2 deck: WGS/Bio Validation 0 compatible column-1 layout...")
    ...
    source_96wp = CellTreat_96_wellplate_350ul_Fb(name="rail35_pos1_targeted_pcr_round2_mm_source_96wp")
...
async def main():
    parser = argparse.ArgumentParser(
        description="Targeted PCR round 2 common master-mix addition, column 1, WGS/Bio Validation 0 compatible deck."
    )
